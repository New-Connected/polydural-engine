...
function updatePos() {
    if (objectSelected[0] != -1) {
        ...
        compiledCamY = 0 - Number(document.getElementById("objectY").value)
        compiledCamZ = 0 - Number(document.getElementById("objectZ").value)
        cameraData[0] = Number(document.getElementById("objectX").value)
        cameraData[1] = 0 - Number(document.getElementById("objectY").value)
        ...
        compiledMeshes[0][2] = 0 - Number(document.getElementById("objectY").value)
        ...
        compiledMeshes[0][17] = 0 - Number(document.getElementById("objectY").value)
